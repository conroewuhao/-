...
@property (nonatomic, strong) CAShapeLayer *hourHand;//小时layer
@property (nonatomic, strong) CAShapeLayer *minuteHand;//分钟layer
...
- (id)init
{
    if ((self = [super init]))
    {
        ...
        self.hourHand.path = [UIBezierPath bezierPathWithRect:CGRectMake(0,-80, 4, 80)].CGPath;
